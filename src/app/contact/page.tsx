  ...
  return (
    <>
      ...
      <main className='m-0 flex items-center justify-center p-0'>
        ...
        <div className='relative mx-4 mt-8 box-border flex flex-col md:flex-row items-start gap-8 p-0 px-1 sm:mx-8 sm:mt-12 md:mt-20 lg:w-240 xl:w-330'>
          <div className={`${styles.slideFromLeft} md:ml-8 lg:mr-12 lg:mt-16 flex-1`}>
            ...
            <Text className='mt-2 w-full font-jakarta text-[0.95rem] font-medium text-secondary md:mt-4 md:w-9/12 md:text-[1.25rem] md:font-light xl:text-[1.35rem]'>
              You can find me on <span className={`${styles.bolded}`}> Discord</span>, <span className={`${styles.bolded}`}>Telegram</span>, <span className={`${styles.bolded}`}>X/Twitter</span>, <span className={`${styles.bolded}`}>Mastodon</span> and more!
            </Text>
          </div>

          <div className='flex flex-col mt-24 w-full md:w-auto'>
            <Text className='font-jakarta text-[13px] text-primary mb-3'>Platforms</Text>
